  ...
  <div class="pbot-settings-layout">
    ...
    <div class="pbot-settings-main">
      <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" id="pbot-writer-form">
        ...
        <!-- Pass the billing route from the saved setting (the sidebar form saves it) -->
        ...
        <div class="pbot-card">
          ...
          <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; margin-top:20px;">
            ...
            <div class="pbot-row pbot-row-stacked">
              ...
              <select id="pbot_tone" name="pbot_tone" style="width:100%;">
          ...
          <!-- Specs section inside the same card -->
        ...
        <div class="pbot-actions-bar" style="margin-top:20px;">
          <button class="button button-primary button-hero" id="pbot_generate_btn" type="submit" <?php echo esc_attr($disabled_btn); ?> style="padding: 0 32px;">Generate Draft</button>
    ...
    <div class="pbot-settings-sidebar">
      ...
      <div class="pbot-card">
        <form method="post" action="options.php">
          ...
          <div class="pbot-muted pbot-route-msgs" style="margin-bottom:15px; font-size:12px; background:#f9f9f9; padding:8px; border-radius:6px;">
            <div id="pbot_route_msg_api" style="display:none;">Uses your OpenAI API billing.</div>
            <div id="pbot_route_msg_credits" style="display:none;">
              Uses Product Key credits (<span class="pbot-credits-left"><?php echo !empty($lic['unlimited']) ? '∞' : (int)max(0, ($lic['limit'] ?? 0) - pbot_writer_usage_get()); ?></span> left).
            </div>
            <div id="pbot_route_msg_brain" style="display:none;">Uses the AI Brain core.</div>
          </div>

          <?php submit_button('Save Route', 'secondary', 'submit', false, ['style'=>'width:100%;']); ?>
        </form>
      </div>
...
(function(){
  ...
  function refreshRouteUI() {
    ...
    // Sync to hidden input for the Generate form
