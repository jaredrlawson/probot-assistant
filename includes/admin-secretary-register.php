...
add_action('wp_ajax_pbot_submit_lead', 'pbot_ajax_submit_lead_handler');
add_action('wp_ajax_nopriv_pbot_submit_lead', 'pbot_ajax_submit_lead_handler');

function pbot_ajax_submit_lead_handler() {
    check_ajax_referer('probot_nonce', 'nonce');
...
add_action('wp_ajax_pbot_toggle_status', 'pbot_ajax_toggle_status_handler');
function pbot_ajax_toggle_status_handler() {
    check_ajax_referer('probot_nonce', 'nonce');
    if (!current_user_can('manage_options')) wp_send_json_error(['message' => 'Unauthorized']);
...
function pbot_handle_vps_proxy() {
    ...
    $payload['provided_key'] = $is_authorized_owner ? $secret_key : 'public_user';
