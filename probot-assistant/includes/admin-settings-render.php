<?php
// ---------------------------------------------
// ProBot Assistant — Admin: Settings Render
// ---------------------------------------------
...
function probot_render_settings_page() {
  ...
  $pulseEn = (bool) get_option('pbot_pulse_enabled', 1);
    ...
    <div class="pbot-card">
      <form method="post" action="options.php">
        ...
        <div class="pbot-row">
          ...
          <input type="text" id="pbot_brand_title" name="pbot_brand_title" value="<?php echo esc_attr($brand); ?>" class="regular-text" />
        </div>
        ...
        <fieldset class="pbot-fieldset">
          ...
          <div class="pbot-row">
            <label><input type="checkbox" name="pbot_pulse_enabled"  value="1" <?php checked($pulseEn,1); ?>> Pulse halo</label>
        ...
        <fieldset class="pbot-fieldset">
          ...
          <div class="pbot-row pbot-color-row">
            ...
            <input type="text" id="pbot_toast_bg_color" name="pbot_toast_bg_color"
                   class="pbot-color-text pbot-auto-text"
        ...
        <fieldset class="pbot-fieldset">
          ...
          <div class="pbot-row">
            ...
            <input type="text" id="pbot_openai_api_key" name="pbot_openai_api_key"
                   class="regular-text" value="<?php echo esc_attr($openaiKey); ?>" autocomplete="off" />
          </div>
          <div class="pbot-row">
            <label for="pbot_product_key"><strong>Product Key</strong></label>
            <input type="text" id="pbot_product_key" name="pbot_product_key"
                   class="regular-text" value="<?php echo esc_attr($productKey); ?>" autocomplete="off" />
          </div>
        </fieldset>
