...
* **Master Brain Rebranding:** Renamed "Dashboard" to "Master Brain" and "Secretary Master Brain" to "AI Master Brain".
...
* **Status Toggle:** Real-time availability switcher (Online/Busy) that informs the AI brain.
...
* **Fix:** Compact HTML and normalized spacing for bot responses.
